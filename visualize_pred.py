from mask2former.predictor import MaskReformerPredictor
from mask2former.config import add_panoptic_deeplab_config
...
from mask_eee_rcnn.utils.visualizer import Visualizer, ColorMode
...
predictor = Predictor()
img_paths = glob.glob('/SSDe/seunghyeok_back/mask-refiner/mask_eee_rcnn_datasets/UOAIS-Sim/val/bin/color/*.png')
