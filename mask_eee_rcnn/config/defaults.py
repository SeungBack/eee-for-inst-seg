...
_C.MODEL.ROI_MASK_EEE_HEAD.CONV_DIM_SHARED = 256
_C.MODEL.ROI_MASK_EEE_HEAD.CONV_DIM_TARGET = 256
_C.MODEL.ROI_MASK_EEE_HEAD.NUM_CONV_SHARED = 3
_C.MODEL.ROI_MASK_EEE_HEAD.NUM_CONV_TARGET = 3
_C.MODEL.ROI_MASK_EEE_HEAD.TARGETS = ["TP", "FP", "FN"]
