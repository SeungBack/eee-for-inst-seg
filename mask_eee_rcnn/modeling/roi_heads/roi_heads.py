...
class StandardROIHeads(ROIHeads):
    ...
    def _init_mask_eee_head(self, cfg):
        self.mask_eee_on = cfg.MODEL.MASK_EEE_ON
    ...
    def _forward_mask_eee(self, mask_features, instances, selected_mask=None, true_positive_mask=None, false_positive_mask=None, false_negative_mask=None):
        ...
        if self.training:
            ...
            if masks.shape[0] == 0:
                return instances
            pred_mask_eee = self.mask_eee_head(mask_features, masks)
            mask_eee_inference(instances, pred_mask_eee)
            return instances
